...
export class DeliveryMove extends Component{
	...
	onFilterChange = (e) => {
		...
		if (name === 'from_date') {
			if(this.state.from_date != value){
				this.state.from_date = `${value} 00:00:00`;
			}
...
DeliveryMove.template = "outward_delivery";
// registry.category("actions").add("product_searches", DeliveryMove);
